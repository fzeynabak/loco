...
INSERT INTO `users` (`id`, `name`, `username`, `email`, `password`, `role`, `status`, `created_at`, `updated_at`, `last_login`, `mobile`, `national_code`, `province_id`, `city_id`, `station_id`) VALUES
(3, 'مصطفی اکرادی', 'akradim', 'akradim@gmail.com', '$2y$10$GwMsgcbbVR8sKBRDbPwaKexo1sB0Cw0AUBVtTFrigt8HZDEfaX6Qa', 'user', 'active', '2025-04-24 20:30:11', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 'مدیر سیستم', 'admin', 'admin@localhost', '$2y$10$Jh/tXdmgCQGSGqGWvvYQFuhZEJsmyxIqYriWsjj5ilitVO8KgQk7u', 'admin', 'active', '2025-04-24 22:41:11', NULL, '2025-04-25 01:22:53', NULL, NULL, NULL, NULL, NULL),
(5, 'مهدی', 'shams', 'shams@hotmail.com', '$2y$10$jUHrW0Zgb0JzAvjDfzK7I.sAU4BSalBRDV9FNwQPvEQAVq42E2pim', 'user', 'active', '2025-04-25 00:41:08', NULL, '2025-04-25 00:41:13', NULL, NULL, NULL, NULL, NULL);
