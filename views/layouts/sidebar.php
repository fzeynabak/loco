<div class="sidebar collapse-horizontal" id="sidebar">
    <nav class="d-flex flex-column flex-shrink-0 p-3 bg-white shadow-lg" style="width: 280px; height: 100%;">
        <!-- Header -->
        <div class="d-flex align-items-center mb-3">
            <button class="btn btn-link text-dark d-lg-none me-3" type="button" data-bs-toggle="collapse" data-bs-target="#sidebar">
